...
databases <- read_tsv("data/database_terms.tsv")
...
intracluster_distances <- 
  ...
  do({
    ...
    intracluster_dist_file <- 
      paste(file_structure[[g_dataset_id]]$evaluation, "intracluster_distances.csv", sep = "/")
    
    if(file.exists(intracluster_dist_file)) {
      gene_distances <-
        read_csv(intracluster_dist_file)
      ...
      write_csv(gene_distances, intracluster_dist_file)
    }
